...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        declared_arguments +
        [model_search, gazebo, spawn_entity, robot_state_pub, rviz, bridge, ekf_node, delayed_controllers,tf_base_husky_base, tf_gz_base_planar, tf_gz_base_front_laser, tf_gz_base_imu]
    )
